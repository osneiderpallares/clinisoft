...
var FullCalendar = function(e) {
        ...
        return 1 === o && "short" === e.timeZoneName ? function(e) {
            ...
            return function(r) {
                ...
                return function(e, t, n, r, o) {
                    ...
                    return e = e.replace(Jt, " "), e = e.trim(), e
    ...
    function Ci(e, t, n, r, o) {
        return {
            header: e.codexEvntFilter ? wi(e.codexEvntFilter, e, t, n, r, o) : null,
    ...
    function Tl(e) {
        ...
        return _o(Oo.Consumer, null, (function(n) {
            ...
            var r = n.dateEnv,
                o = n.options,
                i = n.viewApi,
                a = null == o.slotLabelFormat ? _l : Array.isArray(o.slotLabelFormat) ? ln(o.slotLabelFormat[0]) : ln(o.slotLabelFormat),
                s = {
                    level: 0,
                    time: e.time,
    ...
    var xl = function(e) {
        ...
        Il = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.allDaySplitter = new Rl, t.headerElRef = ko(), t.rootElRef = ko(), t.scrollerElRef = ko(), t.state = {
                    slatCoords: null
                ...
                return f.push({
                    ...
                    chunks: [{
                        ...
                        content: function(e) {
                            ...
                            }, e.tableColGroupNode, _o("tbody", null, _o(xl, {
                                slatMetas: i
                            }))), _o("div", {
        ...
        Ol = function(e) {
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                var e, t = this.context,
                    n = this.props;
                n.onCoords && null !== n.clientWidth && (this.rootElRef.current.offsetHeight && n.onCoords(new Nl(new So(this.rootElRef.current, (e = this.slatElRefs.currentMap, n.slatMetas.map((function(t) {
                    return e[t.key]
    ...
    function Fl(e, t) {
        ...
        return a.sort(Bl), [a.map(zl), a[0][1]]
    }
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                return _o(us, {
                    ...
                    return _o("td", r({
                        ...
                        className: "fc-timegrid-now-indicator-container"
                    }, e.renderNowIndicator(t.nowIndicatorSegs)), _o(Zl, {
                        date: t.date,
                        dateProfile: t.dateProfile,
                        todayRange: t.todayRange,
                        extraHookProps: t.extraHookProps
                ...
                var a = this,
                    ...
                    E = function(e, t, n, r) {
                        ...
                        for (var l = Vl(o, n, r), u = l.segRects, c = l.hiddenGroups, d = [], p = 0, f = u; p < f.length; p++) {
                            var h = f[p];
                            d.push({
                                seg: e[h.index],
                                rect: h
    ...
    var Jl = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitFgEventSegs = qt(Al), t.splitBgEventSegs = qt(Al), t.splitBusinessHourSegs = qt(Al), t.splitNowIndicatorSegs = qt(Al), t.splitDateSelectionSegs = qt(Al), t.splitEventDrag = qt(Ll), t.splitEventResize = qt(Ll), t.rootElRef = ko(), t.cellElRefs = new Fa, t
        }
        return n(t, e), t.prototype.render = function() {
            var e = this,
                t = this.props,
    ...
    var tu = function(e) {
        ...
        nu = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.buildDayRanges = qt(ru), t.slicer = new tu, t.timeColsRef = ko(), t
            }
            return n(t, e), t.prototype.render = function() {
                var e = this,
                    t = this.props,
    ...
    return xi.push($s, wl, lu, yu, Su, Du), e.BASE_OPTION_DEFAULTS = cn, e.BASE_OPTION_REFINERS = un, e.BaseComponent = Uo, e.BgEvent = ds, e.BootstrapTheme = Eu, e.Calendar = Cs, e.CalendarApi = kr, e.CalendarContent = fa, e.CalendarDataManager = Ni, e.CalendarDataProvider = ji, e.CalendarRoot = ga, e.Component = Ro, e.ContentHook = Xo, e.CustomContentRenderContext = Zo, e.DateComponent = Bo, e.DateEnv = Lr, e.DateProfileGenerator = ai, e.DayCellContent = ss, e.DayCellRoot = us, e.DayGridView = bl, e.DayHeader = Ra, e.DaySeriesModel = Ta, e.DayTable = Sl, e.DayTableModel = ka, e.DayTableSlicer = El, e.DayTimeCols = nu, e.DayTimeColsSlicer = tu, e.DayTimeColsView = au, e.DelayedRunner = Mi, e.Draggable = Zs, e.ElementDragging = oa, e.ElementScrollController = Do, e.Emitter = Eo, e.EventApi = xr, e.EventRoot = ns, e.EventSourceApi = ye, e.FeaturefulElementDragging = Os, e.Fragment = xo, e.Interaction = ea, e.ListView = hu, e.MoreLinkRoot = ms, e.MountHook = $o, e.NamedTimeZoneImpl = Gi, e.NowIndicatorRoot = is, e.NowTimer = Ca, e.PointerDragging = Ts, e.PositionCache = So, e.RefMap = Fa, e.RenderHook = Yo, e.ScrollController = bo, e.ScrollResponder = Ho, e.Scroller = Va, e.SegHierarchy = qi, e.SimpleScrollGrid = ts, e.Slicer = xa, e.Splitter = to, e.StandardEvent = rs, e.Table = ml, e.TableDateCell = Sa, e.TableDowCell = Da, e.TableView = Js, e.Theme = wo, e.ThirdPartyDraggable = Ks, e.TimeCols = Ql, e.TimeColsSlatsCoords = Nl, e.TimeColsView = Il, e.ViewApi = Cr, e.ViewContextType = Oo, e.ViewRoot = ti, e.WeekNumberRoot = fs, e.WindowScrollController = Co, e.addDays = tt, e.addDurations = Ot, e.addMs = nt, e.addWeeks = et, e.allowContextMenu = ze, e.allowSelection = Fe, e.applyMutationToEventStore = Sr, e.applyStyle = we, e.applyStyleProp = Re, e.asCleanDays = function(e) {
        ...
        return n
    }, e.buildIsoString = Ft, e.buildNavLinkAttrs = so, e.buildSegCompareObj = nr, e.buildSegTimeText = ar, e.buildSlatMetas = iu, e.buildTimeColsModel = su, e.collectFromHash = kt, e.combineEventUis = xn, e.compareByFieldSpec = qe, e.compareByFieldSpecs = Ge, e.compareNumbers = Ke, e.compareObjs = _t, e.computeEarliestSegStart = Ss, e.computeEdges = ho, e.computeFallbackHeaderFormat = ma, e.computeHeightAndMargins = function(e) {
