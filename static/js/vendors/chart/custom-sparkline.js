$(function() {
    ...
    $('.splinechart').sparkline(spline, 
      {
        ...
        height: '300', 
        lineWidth: 3, 
        lineColor: [Cdxmedixo.themeprimary], 
    ...
    $('.spareachart').sparkline(sparea, 
      {
        ...
        lineWidth: 0, 
        lineColor: [Cdxmedixo.themeprimary],
        fillColor: [Cdxmedixo.themeprimary], 
        highlightSpotColor: '', 
        highlightLineColor: '', 
        spotRadius: 1,                 
      }       
    ...
    $('.sprangechart').sparkline(sprange, 
      {
        ...
        lineColor: [Cdxmedixo.themeprimary],
        fillColor: 'rgba(8, 155, 171, 0.5)', 
        spotColor: [Cdxmedixo.themeprimary],
        spotRadius:5,
        valueSpots:300,
    ...
    $('.spbarchart').sparkline(spbarchart,{
      ...
      barWidth: '35%', 
      barSpacing: 10,
      barColor: [Cdxmedixo.themeprimary],     
   });
  ...
  $('.spstackedchart').sparkline(spstackedchart,{
      ...
      barWidth: '35%', 
      barSpacing: 10,     
      stackedBarColor:[Cdxmedixo.themeprimary,Cdxmedixo.themesecondary,Cdxmedixo.themesuccess],
   });
  ...
  $('.spnegbarchart').sparkline(spnegbarchart,{
      ...
      barSpacing: 10,     
      barColor: [Cdxmedixo.themeprimary],
      negBarColor:[Cdxmedixo.themesecondary],
  ...
  $('.sptristaterchart').sparkline(sptristaterchart,{
      ...
      barWidth: '35%',
      barSpacing: 10,          
      posBarColor:[Cdxmedixo.themeprimary],
      negBarColor:[Cdxmedixo.themesuccess],
      zeroBarColor:[Cdxmedixo.themesecondary],
   });
  ...
  $('.sppiechart').sparkline(sppiechart, 
    {
      ...
      height: '300', 
      lineColor: [Cdxmedixo.themeprimary],     
      sliceColors:[Cdxmedixo.themeprimary,Cdxmedixo.themesecondary,Cdxmedixo.themesuccess,Cdxmedixo.themewarning,Cdxmedixo.themeinfo],
      borderWidth: 5,
      borderColor:'red',
    } ,           
  );
