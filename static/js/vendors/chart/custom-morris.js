...
new Morris.Line({ 
  ...
  lineColors:[Cdxmedixo.themeprimary,Cdxmedixo.themesecondary],
  xkey: 'year',
  ykeys: ['value1','value2'], 
...
Morris.Bar({
  ...
  barColors:[Cdxmedixo.themeprimary,Cdxmedixo.themesecondary],
  xkey: 'y',
  ykeys: ['valuea', 'valueb'],
  labels: ['Series A', 'Series B']
});
...
Morris.Donut({
  ...
  colors:[Cdxmedixo.themeprimary,Cdxmedixo.themesecondary,Cdxmedixo.themewarning,Cdxmedixo.themeinfo]
});
